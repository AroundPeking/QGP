...
#目前只支持精确到2位小数
def scan_parameters(p1_low,p1_high,p1_interval, p2_low,p2_high,p2_interval, p3_low,p3_high,p3_interval, Isu=[9, 10]):
    global SLURM_JOB_ID
...
best_par1, best_par2, best_par3, best_error = scan_parameters(p1_low,p1_high,p1_interval, p2_low,p2_high,p2_interval, p3_low,p3_high,p3_interval, Isu=[9, 10])#目前只支持精确到2位小数
