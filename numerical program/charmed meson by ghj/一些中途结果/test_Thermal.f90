...
! Ds   (c, sbar)  (8, 7) --3
	...
	external meson_TT, meson_TS, meson_SS,int_SS, meson_SS2j, Thermal
	real*8 meson_TT, meson_TS, meson_SS,int_SS, meson_SS2j, Thermal
...
!    CHISQ = 0.0
    ...
    open(unit = 14, file = "Tu_"//CollSys//"_c020.dat", status = "unknown")
    open(unit = 15, file = "Ts_"//CollSys//"_c020.dat", status = "unknown")
    open(unit = 16, file = "Tc_"//CollSys//"_c020.dat", status = "unknown")
    write(14, 98)
    write(15, 98)
    write(16, 98)
...
!    end!function fik(k,IDP) end
    ...
    implicit none 
    external S_ij, F1iq, int_DD0c, int_DD0g, int_DDsc, int_DDsg, int_Djpsic, int_Djpsig, SPD, fik
    real*8   S_ij, int_DD0c,int_DD0g, int_DDsc, int_DDsg, int_Djpsic, int_Djpsig, SPD, fik
    double precision  F1iq, fsum, p, q,int_SS
    integer IDmeson
