...
!   10-20%
!    c = 0.15D0        ! centrality
!    Npart = 260.1D0   ! N participant from experimental data

!   20-40%
!    c = 0.3D0        ! centrality
!    Npart = 157.2D0   ! N participant from experimental data

!   40-60%
!	c = 0.5D0        ! centrality
!	Npart = 68.56D0   ! N participant from experimental data


	Isu =1 ! 1 for pion, 2 for Kaon, 3 for proton, 4 for lambda^0, 5 for Xi, 6 for Phi, 7 for Omega
	IDparticle = Isu
...
!   modified by Lilin August-7-2020
!   Rudy&Chunbin PRC75,054904(07)
	gbst = 0.34D0
...
! pion
	...
	open(unit = 11, file = "dNptdpt_"//CollSys//"_pion1_c025.txt", status = "unknown")
...
! kaon
	...
	open(unit = 11, file = "dNptdpt_"//CollSys//"_kaon1_c025.txt", status = "unknown")
...
! proton
	...
	open(unit = 11, file = "dNptdpt_"//CollSys//"_p1_c025.txt", status = "unknown")
...
! lambda^0
	...
	open(unit = 11, file = "dNptdpt_"//CollSys//"_lambda1_c025.txt", status = "unknown")
...
! Xi
	...
	open(unit = 11, file = "dNptdpt_"//CollSys//"_Xi1_c025.txt", status = "unknown")
...
! phi
	...
	open(unit = 11, file = "dNptdpt_"//CollSys//"_phi1_c025.txt", status = "unknown")
...
! Omega
    ...
    open(unit = 11, file = "dNptdpt_"//CollSys//"_Omega1_c025.txt", status = "unknown")
